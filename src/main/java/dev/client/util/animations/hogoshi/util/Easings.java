...
public final class Easings {
   ...
   public static final Easing SINE_BOTH = (value) -> -(Math.cos(Math.PI * value) - 1.0D) / 2.0D;
   ...
   public static final Easing CIRC_BOTH = (value) -> value < 0.5D ? (1.0D - Math.sqrt(1.0D - Math.pow(2.0D * value, 2.0D))) / 2.0D : (Math.sqrt(1.0D - Math.pow(-2.0D * value + 2.0D, 2.0D)) + 1.0D) / 2.0D;
   public static final Easing ELASTIC_IN = (value) -> value != 0.0D && value != 1.0D ? Math.pow(-2.0D, 10.0D * value - 10.0D) * Math.sin((value * 10.0D - 10.75D) * 2.0943951023931953) : value;
   public static final Easing ELASTIC_OUT = (value) -> value != 0.0D && value != 1.0D ? Math.pow(2.0D, -10.0D * value) * Math.sin((value * 10.0D - 0.75D) * 2.0943951023931953) + 1.0D : value;
   public static final Easing ELASTIC_BOTH = (value) -> {
      if (value != 0.0D && value != 1.0D) {
         return value < 0.5D ? -(Math.pow(2.0D, 20.0D * value - 10.0D) * Math.sin((20.0D * value - 11.125D) * 1.3962634015954636)) / 2.0D : Math.pow(2.0D, -20.0D * value + 10.0D) * Math.sin((20.0D * value - 11.125D) * 1.3962634015954636) / 2.0D + 1.0D;
      } else {
         return value;
      }
   };
   ...
   public static final Easing BACK_IN = (value) -> 2.70158 * Math.pow(value, 3.0D) - 1.70158 * Math.pow(value, 2.0D);
   public static final Easing BACK_OUT = (value) -> 1.0D + 2.70158 * Math.pow(value - 1.0D, 3.0D) + 1.70158 * Math.pow(value - 1.0D, 2.0D);
   public static final Easing BACK_BOTH = (value) -> value < 0.5D ? Math.pow(2.0D * value, 2.0D) * (7.189819 * value - 2.5949095) / 2.0D : (Math.pow(2.0D * value - 2.0D, 2.0D) * (3.5949095 * (value * 2.0D - 2.0D) + 2.5949095) + 2.0D) / 2.0D;
   ...
   public static final Easing BOUNCE_BOTH = (value) -> value < 0.5D ? (1.0D - BOUNCE_OUT.ease(1.0D - 2.0D * value)) / 2.0D : (1.0D + BOUNCE_OUT.ease(2.0D * value - 1.0D)) / 2.0D;
