package dev.client.util.animations.hogoshi;

import dev.client.util.animations.hogoshi.bezier.Bezier;
import dev.client.util.animations.hogoshi.bezier.list.CubicBezier;
import dev.client.util.animations.hogoshi.util.Easing;
import dev.client.util.animations.hogoshi.util.Easings;
...
public class Animation {
   ...
   public double calculatePart() {
      return (double)(System.currentTimeMillis() - this.getStart()) / (double)this.getDuration();
   }
