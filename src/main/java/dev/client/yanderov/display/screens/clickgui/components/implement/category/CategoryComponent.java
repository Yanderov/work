package dev.client.yanderov.display.screens.clickgui.components.implement.category;
...
import dev.client.yanderov.display.screens.clickgui.components.implement.module.ModuleComponent;
...
public class CategoryComponent extends AbstractComponent {
   ...
   private void initializeModules() {
      for(Module module : YanderovIntegration.getInstance().getModuleRepository().modules()) {
