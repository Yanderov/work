...
public class SelfDestruct extends Module {
   ...
   public void activate() {
      unhooked = true;
      YanderovIntegration.getInstance().getDiscordManager().stopRPC();

      for(Module module : YanderovIntegration.getInstance().getModuleProvider().getModules()) {
      ...
      YanderovIntegration.getInstance().getCommandDispatcher();
   ...
   public void onChat(ChatEvent event) {
      ...
      if (msg.equalsIgnoreCase(UserProfile.getInstance().profile("username"))) {
         unhooked = false;
         YanderovIntegration.getInstance().getDiscordManager().setRunning(true);
         this.state = false;
         YanderovIntegration.getInstance().getCommandDispatcher();
