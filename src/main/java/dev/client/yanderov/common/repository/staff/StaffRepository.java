package dev.client.yanderov.common.repository.staff;
...
public class StaffRepository {
   private static final List staffList = new ArrayList();
   ...
   private static void save() {
      FileController fileController = YanderovIntegration.getInstance().getFileController();
   ...
   public static record Staff(String name) {
