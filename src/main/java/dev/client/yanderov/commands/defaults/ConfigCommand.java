...
import dev.client.yanderov.utils.client.managers.api.command.datatypes.ConfigFileDataType;
...
public class ConfigCommand extends Command {
   ...
   public void execute(String label, IArgConsumer args) throws CommandException {
      ...
      if (arg.contains("reset")) {
         ModuleRepository moduleRepository = YanderovIntegration.getInstance().getModuleRepository();
      ...
      if (arg.contains("load")) {
         ...
         if ((new File(customDir, name + ".json")).exists()) {
            try {
               ...
               fileRepository.setup(YanderovIntegration.getInstance());
