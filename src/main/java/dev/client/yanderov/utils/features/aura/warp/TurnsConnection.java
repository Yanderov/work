...
import dev.client.yanderov.utils.math.task.TaskProcessor;
...
public class TurnsConnection implements QuickImports {
   ...
   public TurnsConnection() {
      ...
      YanderovIntegration.getInstance().getEventManager().register(this);
   }
   ...
   public void onPacket(PacketEvent event) {
      if (!event.isCancelled()) {
         ...
         while(true) {
            ...
            // TODO: Fix switch statement for var4
        if (var4 != null) {
            // // case 0:
