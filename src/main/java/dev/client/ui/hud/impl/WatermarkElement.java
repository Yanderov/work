...
public class WatermarkElement extends HudElement {
   ...
   public void render(DrawContext drawContext) {
      ...
      String uid = "1488";
      float size = 7.5F;
      float width = 131.25F + FontManager.SUISSEINTMEDIUM.get().getWidth(fps, size) + FontManager.SUISSEINTMEDIUM.get().getWidth(clientName, size) + FontManager.SUISSEINTMEDIUM.get().getWidth(time, size) + FontManager.SUISSEINTMEDIUM.get().getWidth(uid, size);
      ...
      themeText.render(matrix, (float)(this.draggable.x + 36) + widthName + widthFps + widthTime, (float)(this.draggable.y + 8));
   }
}
