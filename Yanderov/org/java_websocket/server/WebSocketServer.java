...
public abstract class WebSocketServer extends AbstractWebSocket implements Runnable {
            ...
            try {
               ...
               while(!this.selectorthread.isInterrupted() && shutdownCount != 0) {
                  ...
                  try {
                     ...
                     this.handleIOException(key, (WebSocket)null, ex);
               ...
               this.handleFatal((WebSocket)null, e);
            } finally {
   ...
   private void doAccept(SelectionKey key, Iterator i) throws IOException, InterruptedException {
      if (!this.onConnect(key)) {
         ...
         if (channel != null) {
            ...
            WebSocketImpl w = this.wsf.createWebSocket(this, (List)this.drafts);
            ...
            try {
               ...
               this.handleIOException(w.getSelectionKey(), (WebSocket)null, ex);
            }
   ...
   private boolean doSetupSelectorAndServerThread() {
      ...
      try {
         ...
         this.handleFatal((WebSocket)null, ex);
         return false;
      }
   }
   ...
   protected void queue(WebSocketImpl ws) throws InterruptedException {
      if (ws.getWorkerThread() == null) {
         ws.setWorkerThread((WebSocketWorker)this.decoders.get(this.queueinvokes % this.decoders.size()));
         ++this.queueinvokes;
      }
   ...
   private void handleFatal(WebSocket conn, Exception e) {
      ...
      try {
         ...
         this.onError((WebSocket)null, e1);
      }
   ...
   public class WebSocketWorker extends Thread {
      ...
      public WebSocketWorker(final WebSocketServer this$0) {
      ...
      public void run() {
         ...
         try {
            ...
            WebSocketServer.this.log.error("Uncaught exception in thread {}: {}", this.getName(), e);
            if (ws != null) {
               Exception exception = new Exception(e);
