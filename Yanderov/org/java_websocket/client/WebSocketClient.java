...
public abstract class WebSocketClient extends AbstractWebSocket implements Runnable, WebSocket {
   ...
   public void run() {
      ...
      try {
         ...
         if (var9.getCause() instanceof InvocationTargetException && var9.getCause().getCause() instanceof IOException) {
            IOException cause = (IOException)var9.getCause().getCause();
