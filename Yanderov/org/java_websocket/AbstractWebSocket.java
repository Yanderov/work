...
public abstract class AbstractWebSocket extends WebSocketAdapter {
   ...
   private void restartConnectionLostTimer() {
      ...
      Runnable connectionLostChecker = new Runnable(this) {
         ...
         public void run() {
            ...
            try {
               ...
               synchronized(AbstractWebSocket.this.syncConnectionLost) {
                  minimumPongTime = (long)((double)System.nanoTime() - (double)AbstractWebSocket.this.connectionLostTimeout * (double)1.5F);
               }
