...
public abstract class AbstractPowerSource implements PowerSource {
   ...
   public boolean updateAttributes() {
      for(PowerSource ps : getPowerSources()) {
   ...
   private static List getPowerSources() {
   ...
   public String toString() {
      ...
      sb.append("RemainingCapacityPercent: ").append(this.getRemainingCapacityPercent() * (double)100.0F).append("%, ");
      ...
      sb.append("Voltage: ");
      if (this.getVoltage() > (double)0.0F) {
      ...
      if (this.getTemperature() > (double)0.0F) {
   ...
   private static String formatTimeRemaining(double timeInSeconds) {
      ...
      if (timeInSeconds < (double)-1.5F) {
         formattedTimeRemaining = "Charging";
      } else if (timeInSeconds < (double)0.0F) {
         formattedTimeRemaining = "Unknown";
      } else {
         int hours = (int)(timeInSeconds / (double)3600.0F);
         int minutes = (int)(timeInSeconds % (double)3600.0F / (double)60.0F);
