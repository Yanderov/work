...
public abstract class AbstractHardwareAbstractionLayer implements HardwareAbstractionLayer {
   private final Supplier computerSystem = Memoizer.memoize(this::createComputerSystem);
   private final Supplier processor = Memoizer.memoize(this::createProcessor);
   private final Supplier memory = Memoizer.memoize(this::createMemory);
   private final Supplier sensors = Memoizer.memoize(this::createSensors);
