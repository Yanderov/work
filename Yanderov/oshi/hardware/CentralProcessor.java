...
public interface CentralProcessor {
   ...
   public static enum TickType {
      ...
      // $FF: synthetic method
      private static TickType[] $values() {
         return new TickType[]{USER, NICE, SYSTEM, IDLE, IOWAIT, IRQ, SOFTIRQ, STEAL};
      }
   }
   ...
   public static class ProcessorCache {
      ...
      public static enum Type {
         ...
         private static Type[] $values() {
            return new Type[]{UNIFIED, INSTRUCTION, DATA, TRACE};
         }
      }
   }
   ...
   public static final class ProcessorIdentifier {
      ...
      private final Supplier microArchictecture;
