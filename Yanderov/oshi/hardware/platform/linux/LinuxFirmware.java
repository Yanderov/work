...
final class LinuxFirmware extends AbstractFirmware {
   ...
   private final Supplier description = Memoizer.memoize(this::queryDescription);
   private final Supplier version = Memoizer.memoize(this::queryVersion);
   private final Supplier releaseDate = Memoizer.memoize(this::queryReleaseDate);
   private final Supplier name = Memoizer.memoize(this::queryName);
   private final Supplier vcGenCmd = Memoizer.memoize(LinuxFirmware::queryVcGenCmd);
   private final Supplier biosNameRev = Memoizer.memoize(Dmidecode::queryBiosNameRev);
