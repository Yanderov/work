...
final class LinuxBaseboard extends AbstractBaseboard {
   ...
   private final Supplier model = Memoizer.memoize(this::queryModel);
   private final Supplier version = Memoizer.memoize(this::queryVersion);
   private final Supplier serialNumber = Memoizer.memoize(this::querySerialNumber);
   private final Supplier manufacturerModelVersionSerial = Memoizer.memoize(CpuInfo::queryBoardInfo);
