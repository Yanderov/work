...
final class WindowsBaseboard extends AbstractBaseboard {
   private final Supplier manufModelVersSerial = Memoizer.memoize(WindowsBaseboard::queryManufModelVersSerial);
   ...
   private static Quartet queryManufModelVersSerial() {
