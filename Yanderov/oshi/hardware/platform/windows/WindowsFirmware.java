...
final class WindowsFirmware extends AbstractFirmware {
   private final Supplier manufNameDescVersRelease = Memoizer.memoize(WindowsFirmware::queryManufNameDescVersRelease);
   ...
   private static Quintet queryManufNameDescVersRelease() {
