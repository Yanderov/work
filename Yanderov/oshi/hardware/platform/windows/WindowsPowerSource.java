...
public final class WindowsPowerSource extends AbstractPowerSource {
   private static final Guid.GUID GUID_DEVCLASS_BATTERY = GUID.fromString("{72631E54-78A4-11D0-BCF7-00AA00B7B32A}");
   ...
   private static WindowsPowerSource getPowerSource(String name) {
      ...
      try {
         if (0 == PowrProf.INSTANCE.CallNtPowerInformation(5, (Pointer)null, 0, batteryState.getPointer(), batteryState.size()) && batteryState.batteryPresent > 0) {
            if (batteryState.acOnLine == 0 && batteryState.charging == 0 && batteryState.discharging > 0) {
               ...
               psTimeRemainingEstimated = (double)-2.0F;
            }

            psMaxCapacity = batteryState.maxCapacity;
            psCurrentCapacity = batteryState.remainingCapacity;
            psRemainingCapacityPercent = Math.min((double)1.0F, (double)psCurrentCapacity / (double)psMaxCapacity);
                                                                              ...
                                                                              if (Kernel32.INSTANCE.DeviceIoControl(hBattery, 2703428, bqi.getPointer(), bqi.size(), bi.getPointer(), bi.size(), dwOut, (Pointer)null)) {
                                                                                 ...
                                                                                 if (0 != (bi.Capabilities & Integer.MIN_VALUE) && 0 == (bi.Capabilities & 536870912)) {
                                                                                    ...
                                                                                    if (Kernel32.INSTANCE.DeviceIoControl(hBattery, 2703436, bws.getPointer(), bws.size(), bs.getPointer(), bs.size(), dwOut, (Pointer)null)) {
                                                                                       ...
                                                                                       psVoltage = bs.Voltage > 0 ? (double)bs.Voltage / (double)1000.0F : (double)bs.Voltage;
                                                                                 ...
                                                                                 try {
                                                                                    if (Kernel32.INSTANCE.DeviceIoControl(hBattery, 2703428, bqi.getPointer(), bqi.size(), tempK.getPointer(), 4, dwOut, (Pointer)null)) {
                                                                                       psTemperature = (double)tempK.getValue() / (double)10.0F - 273.15;
                                                                                    }
                                                                                 ...
                                                                                 try {
                                                                                    if (Kernel32.INSTANCE.DeviceIoControl(hBattery, 2703428, bqi.getPointer(), bqi.size(), tempK.getPointer(), 4, dwOut, (Pointer)null)) {
                                                                                       psTimeRemainingInstant = (double)tempK.getValue();
                                                                                    }
                                                                                 ...
                                                                                 tempK.close();
                                                                                 if (psTimeRemainingInstant < (double)0.0F && psPowerUsageRate != 0) {
                                                                                    psTimeRemainingInstant = (double)(psMaxCapacity - psCurrentCapacity) * (double)3600.0F / (double)psPowerUsageRate;
                                                                                    if (psTimeRemainingInstant < (double)0.0F) {
                                                                                       psTimeRemainingInstant *= (double)-1.0F;
                                                                                    }
                                                                                 }
