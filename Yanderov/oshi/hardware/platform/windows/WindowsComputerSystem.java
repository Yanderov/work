...
final class WindowsComputerSystem extends AbstractComputerSystem {
   private final Supplier manufacturerModel = Memoizer.memoize(WindowsComputerSystem::queryManufacturerModel);
   private final Supplier serialNumberUUID = Memoizer.memoize(WindowsComputerSystem::querySystemSerialNumberUUID);
   ...
   private static Pair queryManufacturerModel() {
   ...
   private static Pair querySystemSerialNumberUUID() {
