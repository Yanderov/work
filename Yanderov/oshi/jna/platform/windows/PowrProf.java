...
public interface PowrProf extends com.sun.jna.platform.win32.PowrProf {
   ...
   public static enum BATTERY_QUERY_INFORMATION_LEVEL {
      ...
      // $FF: synthetic method
      private static BATTERY_QUERY_INFORMATION_LEVEL[] $values() {
         return new BATTERY_QUERY_INFORMATION_LEVEL[]{BatteryInformation, BatteryGranularityInformation, BatteryTemperature, BatteryEstimatedTime, BatteryDeviceName, BatteryManufactureDate, BatteryManufactureName, BatteryUniqueID, BatterySerialNumber};
      }
   }
