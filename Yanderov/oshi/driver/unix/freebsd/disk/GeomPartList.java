...
public final class GeomPartList {
   ...
   public static Map queryPartitions() {
      ...
      if (diskName != null) {
         ...
         if (!partList.isEmpty()) {
            List var15 = (List)partList.stream().sorted(Comparator.comparing(HWPartition::getName)).collect(Collectors.toList());
            partitionMap.put(diskName, var15);
         }
      }
