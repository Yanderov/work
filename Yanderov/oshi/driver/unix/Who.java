...
public final class Who {
   ...
   public static synchronized List queryWho() {
   ...
   private static boolean matchLinux(List whoList, String s) {
      ...
      if (m.matches()) {
         try {
            ...
            return true;
         } catch (NullPointerException | DateTimeParseException var4) {
         }
      }
   ...
   private static boolean matchUnix(List whoList, String s) {
      ...
      if (m.matches()) {
         try {
            ...
            return true;
         } catch (NullPointerException | DateTimeParseException var6) {
         }
      }
