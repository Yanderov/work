...
public final class Win32LogicalDiskToPartition {
   ...
   public static WbemcliUtil.WmiResult queryDiskToPartition(WmiQueryHandler h) {
   ...
   public static enum DiskToPartitionProperty {
      ...
      // $FF: synthetic method
      private static DiskToPartitionProperty[] $values() {
         return new DiskToPartitionProperty[]{ANTECEDENT, DEPENDENT, ENDINGADDRESS, STARTINGADDRESS};
      }
   }
}
