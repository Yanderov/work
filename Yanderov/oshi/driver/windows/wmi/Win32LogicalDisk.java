...
public final class Win32LogicalDisk {
   ...
   public static WbemcliUtil.WmiResult queryLogicalDisk(String nameToMatch, boolean localOnly) {
      ...
      return ((WmiQueryHandler)Objects.requireNonNull(WmiQueryHandler.createInstance())).queryWMI(logicalDiskQuery);
   }
   ...
   public static enum LogicalDiskProperty {
      ...
      // $FF: synthetic method
      private static LogicalDiskProperty[] $values() {
         return new LogicalDiskProperty[]{ACCESS, DESCRIPTION, DRIVETYPE, FILESYSTEM, FREESPACE, NAME, PROVIDERNAME, SIZE, VOLUMENAME};
      }
   }
}
