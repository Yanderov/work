...
public final class MSAcpiThermalZoneTemperature {
   ...
   public static WbemcliUtil.WmiResult queryCurrentTemperature() {
      ...
      return ((WmiQueryHandler)Objects.requireNonNull(WmiQueryHandler.createInstance())).queryWMI(curTempQuery);
   }
   ...
   public static enum TemperatureProperty {
      ...
      // $FF: synthetic method
      private static TemperatureProperty[] $values() {
         return new TemperatureProperty[]{CURRENTTEMPERATURE};
      }
   }
}
