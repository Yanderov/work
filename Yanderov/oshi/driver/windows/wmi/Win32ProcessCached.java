...
public final class Win32ProcessCached {
   private static final Supplier INSTANCE = Memoizer.memoize(Win32ProcessCached::createInstance);
   @GuardedBy("commandLineCacheLock")
   private final Map commandLineCache = new HashMap();
