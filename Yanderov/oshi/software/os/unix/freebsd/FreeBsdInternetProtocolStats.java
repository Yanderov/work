...
public class FreeBsdInternetProtocolStats extends AbstractInternetProtocolStats {
   ...
   private Supplier tcpstat = Memoizer.memoize(FreeBsdInternetProtocolStats::queryTcpstat, Memoizer.defaultExpiration());
   private Supplier udpstat = Memoizer.memoize(FreeBsdInternetProtocolStats::queryUdpstat, Memoizer.defaultExpiration());
