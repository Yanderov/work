...
public class HotKeys extends AbstractDraggable {
   ...
   public void tick() {
      this.keysList = Yanderov.getInstance().getModuleProvider().getModules().stream().filter((module) -> module.getAnimation().getOutput().floatValue() != 0.0F && module.getKey() != -1).toList();
