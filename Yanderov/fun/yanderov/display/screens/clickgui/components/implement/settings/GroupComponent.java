...
import fun.Yanderov.display.screens.clickgui.components.implement.other.CheckComponent;
import fun.Yanderov.display.screens.clickgui.components.implement.other.SettingComponent;
import fun.Yanderov.display.screens.clickgui.components.implement.window.AbstractWindow;
import fun.Yanderov.display.screens.clickgui.components.implement.window.implement.settings.group.GroupWindow;
