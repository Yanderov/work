...
import fun.Yanderov.display.screens.clickgui.components.implement.module.PanelsModuleComponent;
...
public class CategoryPanelComponent extends AbstractComponent {
   ...
   public CategoryPanelComponent(ModuleCategory category) {
      ...
      for(Module m : Yanderov.getInstance().getModuleRepository().modules()) {
