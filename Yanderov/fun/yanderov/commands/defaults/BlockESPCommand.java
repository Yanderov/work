...
public class BlockESPCommand extends Command {
   ...
   public void execute(String label, IArgConsumer args) throws CommandException {
      if (!args.hasAny()) {
         ...
         BlockESP blockESP = (BlockESP)Yanderov.getInstance().getModuleRepository().modules().stream().filter((module) -> module instanceof BlockESP).findFirst().orElse((Object)null);
         if (blockESP == null) {
