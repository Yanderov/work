package fun.Yanderov.utils.connection.irc;

import antidaunleak.api.UserProfile;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import fun.Yanderov.Yanderov;
import fun.Yanderov.commands.defaults.IRCCommand;
...
public class IRCWebSocketClient extends WebSocketClient {
   ...
   public void onOpen(ServerHandshake handshakedata) {
      this.sendGetPrefix();
      Yanderov.getInstance().getIrcManager().isConnecting.set(false);
   }
   ...
   private void handleMessage(String jsonMessage) {
      try {
         ...
         if (type.equals("text")) {
            ...
            if (Yanderov.getInstance().isShowIrcMessages()) {
            ...
            this.isMuted = true;
            if (Yanderov.getInstance().isShowIrcMessages() && json.has("reason") && json.has("duration_minutes")) {
   ...
   void displayMessage(String prefix, String message, String author, String content) {
      if (class_310.method_1551().field_1724 != null && Yanderov.getInstance().isShowIrcMessages()) {
