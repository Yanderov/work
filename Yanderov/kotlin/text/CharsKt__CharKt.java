...
@Metadata(
   ...
   d2 = {"", "", "digitToChar", "(I)C", "radix", "(II)C", "digitToInt", "(C)I", "(CI)I", "digitToIntOrNull", "(C)Ljava/lang/Integer;", "(CI)Ljava/lang/Integer;", "other", "", "ignoreCase", "equals", "(CCZ)Z", "isSurrogate", "(C)Z", "", "plus", "(CLjava/lang/String;)Ljava/lang/String;", "titlecase", "(C)Ljava/lang/String;", "kotlin-stdlib"},
